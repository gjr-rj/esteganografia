class LSB extends TLSB
{
  //A técnica LSB é representada por 0b00000010
  static byte tipoEsteganografia_LSB = (byte)0b00000010;
  ...
  {
    return (tamConteudo - (13*8))/8;
  }
  
  static long verificaMaxTamDadoTxt(long tamConteudo)
  {
    return (tamConteudo - (9*8))/8;
  }
  
  public LSB (TArquivoMidia arquivo)
  {
    super(arquivo);
  }
  ...
  {
    return (tamMaxEsteg() - tamRodape())/8;
  }
  
  public long qtdeByteEsteg(long tamDado)
  {
    return ((long)((tamMaxEsteg() - tamRodape())/8))*8;
  }
